...
extern void draw_bitmap_spi(int x1, int y1, int width, int height, int scale, int fc, int bc, unsigned char *bitmap);
...
extern void lcd_print_char(int fc, int bc, char c, int orientation);
extern void lcd_set_cursor(int x, int y);
extern void lcd_set_text_colors(int fg_color, int bg_color);
